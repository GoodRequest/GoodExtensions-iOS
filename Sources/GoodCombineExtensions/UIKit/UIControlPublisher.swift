...
public struct UIControlPublisher<Control: UIControl>: Publisher {
    ...
    /// A weak reference to an instance of the Control type.
    weak var control: Control?
    /// Specifies the event that the publisher should listen for.
    ...
    /// Creates a `UIControlSubscription` instance and passes it to the subscriber.
...
public extension GRActive where Base: UIControl {
    ...
    ///  This function returns a `UIControlPublisher` for a given `UIControl.Event`.
    /// - Parameter event: event, which is of type `UIControl.Event`.
    /// - Returns: `UIControlPublisher`
...
public extension Combine.Publishers {
    ...
    struct ControlProperty<Control: UIControl, Value>: Publisher {
        ...
        /// Creates a `UIControlKeyPathSubscription` instance and passes it to the subscriber
