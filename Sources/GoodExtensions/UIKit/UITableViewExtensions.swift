...
public extension GRActive where Base: UITableView {
    ...
    /// Resizes the header view of a `UITableView` to fit its contents.
    ...
    /// Updates `UITableView` header view width
    ...
    /// Resizes the footer view of a `UITableView` to fit its contents.
